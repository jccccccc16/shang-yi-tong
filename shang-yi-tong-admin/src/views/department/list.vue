...
export default {
  ...
  methods: {
    ...
    //查询排班详情
    getDetailSchedule() {
      departmentApi.getDetailSchedule(this.hoscode,this.depcode,this.workDate)
        .then(response => {
    ...
    // 调用接口
    fetchData() {
      departmentApi.getDepartments(this.hoscode)
        .then(response => {
    ...
    getScheduleRule() {
      departmentApi.getScheduleRule(this.page, this.limit, this.hoscode, this.depcode).then(response => {
